...
export default function AskAIFeatureSection(): JSX.Element {
	return (
		<section className="w-full py-20 md:py-24 lg:py-28 relative" >
			<SectionWrapper text={"Features".toUpperCase()} >
				<div className="app__shape-circle w-[250px] lg:w-[300px] aspect-square rounded-full absolute top-[30%] md:top-[40%] lg:bottom-[5%] left-[5%] xs:left-[10%] sm:left-[20%] md:left-[35%] lg:left-[25%]" />
				<div className="w-full h-full flex flex-col justify-center items-center" >
					<div className="w-full flex flex-col items-center justify-center" > 
						...
						<div className="my-10 text-center" >
							<p className="app__brand-text text-[var(--color-brand)] text-[0.725rem] xs:text-[0.75rem] sm:text-[0.825rem] md:text-[0.85rem] lg:text-[0.875rem]" >We shape Our code capabilities around</p>
						...
						<div className="w-4/5 flex justify-center items-center flex-wrap gap-8" >
							{features.map(item => (
